...
const tokens: Token[] = [
  { symbol: 'ETH', name: 'Ethereum', address: ethers.ZeroAddress, decimals: 18 },
];
...
export default function BridgePage() {
  ...
  const handleBridge = async () => {
    ...
    try {
      ...
      // const tx = await bridgeContract.bridge({ value: amountWei });
  ...
  return (
    <div className="min-h-screen bg-surface text-ink">
      ...
      <main className="pt-20 pb-12 px-4 sm:px-6 max-w-lg mx-auto">
        {/* Header */}
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-2 text-ink">Bridge to AgentL2</h1>
        ...
        <div className="card">
            ...
            <div className="flex gap-2">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-3 bg-surface-elevated border border-border rounded-xl hover:border-ink-subtle transition-colors"
                >
              ...
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-surface-elevated border border-border rounded-xl text-lg font-medium focus:border-accent focus:outline-none transition-colors disabled:opacity-50"
                />
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-surface-elevated border border-border rounded-xl">
          ...
          {amount && parseFloat(amount) > 0 && (
            <div className="p-4 bg-surface-muted rounded-xl mb-6 space-y-2 text-sm">
          ...
          {!address ? (
            <button
              ...
              className="w-full py-4 bg-accent text-white font-medium rounded-xl hover:bg-accent/90 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
            ...
            <button
              disabled
              className="w-full py-4 bg-surface-elevated text-ink-muted font-medium rounded-xl flex items-center justify-center gap-2"
            >
