...
async function main() {
    ...
    const serviceId = await agentA.offerService('sentiment-analysis', ethers_1.ethers.parseEther('0.001'), 'ipfs://QmSentimentServiceMetadata');
    ...
    console.log('Summary: 2 agents, 1 service, 1 order,', ethers_1.ethers.formatEther(identityA.totalEarned), 'ETH earned by Agent A');
}
main()
    .then(() => process.exit(0))
    .catch((e) => {
