...
async function demo() {
  ...
  const agentA = new AgentClient({
    ...
    registryAddress: process.env.REGISTRY_ADDRESS || '0x2279B7A0a67DB372996a5FaB50D91eAA73d2eBe6',
    marketplaceAddress: process.env.MARKETPLACE_ADDRESS || '0x8A791620dd6260079BF849Dc5567aDC3F2FdC318',
    chainId: 1337,
  });
