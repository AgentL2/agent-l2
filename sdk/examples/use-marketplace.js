...
async function main() {
    ...
    console.log(`Total Price: ${ethers_1.ethers.formatEther(totalPrice)} ETH`);
    try {
        const orderId = await client.purchaseService(service.serviceId, units, 3600 // 1 hour deadline
        );
        ...
        console.log('\n📊 Updated Stats:');
        console.log('Total Spent:', ethers_1.ethers.formatEther(identity.totalSpent), 'ETH');
